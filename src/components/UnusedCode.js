...
//                     /> 
//                 </Row>
//                 <Row className="margin-bottom--50px margin-left-none margin-right-none new-kpi-bar" noGutters={true}>
//                 <Col>
//                     <Row>
...
//                     <Col>
//                     <Row>
//                         <Col xs={6} className="kpi-col flex align_items_center padding-right-none">
//                         <div>
//                             {/* <span className="kpi-bold">{`${this.props.title}     `}</span> */}
//                             <span className="kpi-bold-title">KPI title</span>
//                         </div>
...
//                         </div>
//                         </Col>
//                         <Col xs={6} className="flex align_items_center">
//                         <div className={(this.props.positive ? "kpi-arrow-up" : "kpi-arrow-down")}></div>
//                         <div className="text_mediumgrey">
//                             <span class="text_red"> 23
//                             </span>
